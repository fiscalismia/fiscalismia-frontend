...
export const locales_en = {
  ...
  ADMIN_AREA_CDP_PERFORMANCE_START_CDP_SESSION_BTN: 'Start CDP Session',
  ADMIN_AREA_CDP_PERFORMANCE_TOGGLE_USER_INPUT_BTN: (pos1: boolean) => `${pos1 ? 'Deactivate' : 'Activate'} User Input`,
  ...
  ADMIN_AREA_CDP_PERFORMANCE_TEST_WS_UNDEFINED_BITMAP_ERROR: 'Bitmap Conversion rejected.',
  ...
  VARIABLE_EXPENSES_STORES_BUBBLE_CHART_TITLE: 'Store Overview',
  VARIABLE_EXPENSES_STORES_HEADER_INFO_STORE_COUNT: 'Stores',
  VARIABLE_EXPENSES_STORES_HEADER_INFO_MONEY_SPENT: 'spent total',
  VARIABLE_EXPENSES_STORES_HEADER_INFO_STORE_VISITS: 'purchases',
  VARIABLE_EXPENSES_STORES_HEADER_INFO_PROGRESS_BAR_PLANNED: (pos1: string) => `${pos1}% planned`,
  VARIABLE_EXPENSES_STORES_HEADER_INFO_STORE_VISITS_PLANNED: 'planned purch.',
  VARIABLE_EXPENSES_STORES_HEADER_INFO_STORE_VISITS_UNPLANNED: 'spontan. purch.',
  VARIABLE_EXPENSES_STORES_HEADER_BUBBLE_X_AXIS_LABEL: 'Total visits',
  ...
  NOTIFICATION_ADMIN_AREA_CDP_NON_BLOB_MSG_RECEIVED: 'Server message is not of type Blob',
  NOTIFICATION_ADMIN_AREA_CDP_PERFORMANCE_USER_INPUT_ENABLED: 'User Input enabled',
  NOTIFICATION_ADMIN_AREA_CDP_PERFORMANCE_USER_INPUT_DISABLED: 'User Input disabled',
