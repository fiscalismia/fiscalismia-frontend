...
export const locales_en = {
  ...
  VARIABLE_EXPENSES_STORES_HEADER_INFO_MONEY_SPENT: 'spent',
  ...
  VARIABLE_EXPENSES_STORES_HEADER_INFO_STORE_VISITS_PLANNED: 'planned purchases',
  VARIABLE_EXPENSES_STORES_HEADER_INFO_STORE_VISITS_UNPLANNED: 'spontaneous purchases',
