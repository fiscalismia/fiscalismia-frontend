export const paths = {
  ...
  ADMIN_CDP_PERFORMANCE_TEST: 'admin/cdp_performance',
  ADMIN_WEBSCRAPE_SUPERMARKETS: 'admin/webscrape_supermarkets',
  ADMIN_UPLOAD_MANUAL: 'admin/upload_manual',
  ADMIN_ETL_RAW_DATA: 'admin/etl_raw_data'
};
