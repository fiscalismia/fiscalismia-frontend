...
export const locales_de = {
  ...
  MENU_UPLOAD_MANUAL: 'Manueller DB Upload',
  ...
  MENU_WEBSCRAPE_SUPERMARKETS: 'Supermarkt Webscraping',
  ...
  ADMIN_AREA_CDP_PERFORMANCE_START_CDP_SESSION_BTN: 'CDP Session initiieren',
  ADMIN_AREA_CDP_PERFORMANCE_TOGGLE_USER_INPUT_BTN: (pos1: boolean) =>
    `User Input ${pos1 ? 'deaktivieren' : 'aktivieren'}`,
  ...
  MINOR_FILTER_FOOD_PRICES_SORT_CRITERIA_BTN_VALUE_NORMALIZED_PRICE: 'Normalisierter Preis',
  ...
  VARIABLE_EXPENSES_OVERVIEW_CATEGORY_VACATION: 'Vacation',
  VARIABLE_EXPENSES_OVERVIEW_CATEGORY_HOME_OFFICE: 'Home Office',
  VARIABLE_EXPENSES_OVERVIEW_CATEGORY_HOUSEHOLD: 'Household',
  ...
  VARIABLE_EXPENSES_OVERVIEW_CATEGORY_COMBINED_HOME_AND_HOUSEHOLD: 'Home & Household',
  ...
  VARIABLE_EXPENSES_STORES_HEADER_INFO_STORE_COUNT: 'Verkaufsst.',
  VARIABLE_EXPENSES_STORES_HEADER_INFO_MONEY_SPENT: 'ausgegeben',
  VARIABLE_EXPENSES_STORES_HEADER_INFO_STORE_VISITS: 'Einkäufe',
  VARIABLE_EXPENSES_STORES_HEADER_INFO_PROGRESS_BAR_PLANNED: (pos1: string) => `${pos1}% geplant`,
  VARIABLE_EXPENSES_STORES_HEADER_INFO_STORE_VISITS_PLANNED: 'Einkäufe geplant',
  VARIABLE_EXPENSES_STORES_HEADER_INFO_STORE_VISITS_UNPLANNED: 'Einkäufe spontan',
  VARIABLE_EXPENSES_STORES_HEADER_BUBBLE_X_AXIS_LABEL: 'Anzahl Besuche',
  ...
  NOTIFICATION_ADMIN_AREA_CDP_NON_BLOB_MSG_RECEIVED: 'Server message ist kein Blob',
  NOTIFICATION_ADMIN_AREA_CDP_PERFORMANCE_USER_INPUT_ENABLED: 'User Input aktiviert',
  NOTIFICATION_ADMIN_AREA_CDP_PERFORMANCE_USER_INPUT_DISABLED: 'User Input deaktiviert',
