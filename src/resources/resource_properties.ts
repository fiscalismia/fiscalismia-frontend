...
export const resourceProperties = {
  ...
  KCAL: 'kcal',
  BUDGET: 'Budget',
  GITHUB_FRONTEND_URL: 'https://github.com/fiscalismia/fiscalismia-frontend',
  GITHUB_BACKEND_URL: 'https://github.com/fiscalismia/fiscalismia-backend',
  GITHUB_INFRASTRUCTURE_URL: 'https://github.com/fiscalismia/fiscalismia-infrastructure',
